...
import { Download, FileText, FileSpreadsheet, FileType2, Loader2, Plane, Compass, ClipboardList, Layers, AlertCircle, Wallet } from 'lucide-react';
...
export default function ExportMenu({ tripId, trip, activeTab }) {
  ...
  const scopes = [
    ...
    { key: 'expenses',  label: 'הוצאות',       icon: <Wallet size={14} /> },
